...
from newdesign_split_test_ELEN_dualnetwork_only_step import RSN
...
def main():
    ...
    #flops = FlopCountAnalysis(model=model, inputs=tensor).total()
    #params = parameter_count_table(model=model)
    #print("flops =", flops/1e9)
    #print(params)
    #stat(model, (3,256,192))
    summary(model, input_size=(3, 256, 192), batch_size=-1, device='cuda')
