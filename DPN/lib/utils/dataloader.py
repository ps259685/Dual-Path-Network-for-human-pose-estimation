...
from dataset.LSP.lsp import LSPDataset
from dataset.OCHuman.ochuman import OCHumanCOCODataset
from dataset.HumanArt.humanart import HumanArtDataset



def get_train_loader(
        cfg, num_gpu, is_dist=True, is_shuffle=False, start_iter=0):
    ...
    if cfg.DATASET.NAME == 'COCO':
        ...
        Dataset = MPIIDataset
    elif cfg.DATASET.NAME == 'OCHuman':
        Dataset = OCHumanCOCODataset
    elif cfg.DATASET.NAME == 'HumanArt':
